export const translations = {
  en: {
    ...
    hero: {
      ...
      description: 'Transform your teaching with AI-powered transcription, IB compliance checks, and adaptive learning insights.',
      cta: 'Get Started',
      demo: 'Watch Demo',
    },
    features: {
  ...
  es: {
    ...
    hero: {
      ...
      description: 'Transforma tu enseñanza con transcripción impulsada por IA, verificación de cumplimiento IB e insights de aprendizaje adaptativo.',
      cta: 'Comenzar',
      demo: 'Ver Demo',
    },
    features: {
